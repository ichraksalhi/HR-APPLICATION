...
class DetailsPersonalityTest extends React.Component {
  render() {
    return (
      <>
        <div
        ...
        >
          {/* Mask */}
          <span className="mask bg-gradient-red" />
          {/* Header container */}
...
export default DetailsPersonalityTest;
