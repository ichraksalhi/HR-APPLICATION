               ...
               <h2 style={{fontWeight:'bold'}}>DISC Test </h2>
                <div>
                    <p>
                        ...
                        <span className="right">{time.minutes}:{time.seconds}<span><Icon className="lifeline"  icon={clockOutline} /></span></span>
                    </p>
                </div>
             <h5>{currentQuestion.question}</h5>
               <div className="options-container">
                <p onClick={this.handleOptionClick} className="optionsRed">{currentQuestion.optionA}</p> 
                <p onClick={this.handleOptionClick} className="optionsGreen">{currentQuestion.optionB}</p>    
                </div>  
                <div className="options-container">
                <p onClick={this.handleOptionClick} className="options">{currentQuestion.optionC}</p> 
                <p onClick={this.handleOptionClick} className="optionsYellow">{currentQuestion.optionD}</p>    
                </div> 
